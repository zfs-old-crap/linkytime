...
public class EditMeetingCommandParser implements Parser<EditMeetingCommand> {
    ...
    public EditMeetingCommand parse(String args) throws ParseException {
        ...
        final ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_URL, PREFIX_DATETIME, PREFIX_DURATION,
    ...
    private Optional<Set<Tag>> parseTagsForEdit(Collection<String> tags) throws ParseException {
        ...
        final Collection<String> tagSet = tags.size() == 1 && tags.contains("") ? Collections.emptySet() : tags;
