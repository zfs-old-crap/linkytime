 ...
 * A module is considered unique by comparing using {@code Module#equals(Object)}. As such, adding and updating
 * of modules uses Module#equals(Object) for equality so as to ensure that the module being added or
 * updated is unique in terms of identity in the UniqueModuleList. However, the removal of a module uses
...
public class UniqueModuleList implements Iterable<Module> {
     ...
     * as another existing module in the list.
     */
