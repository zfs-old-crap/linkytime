...
/**
 * A list of meeting entries that enforces uniqueness between its elements and does not allow nulls.
 * A meeting entry is considered unique by comparing using {@code MeetingEntry#equals(Object)}. As such, adding,
 * updating, and removing of meeting entries uses MeetingEntry#equals(Object) for equality to ensure that the
 * meeting entry being added or updated is unique in terms of identity in the UniqueMeetingEntryList.
 *
 * Supports a minimal set of list operations.
 *
 * @see MeetingEntry#equals(Object)
 */
