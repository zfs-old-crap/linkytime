...
import static seedu.address.testutil.TypicalIndexes.INDEX_THIRD_MEETING_ENTRY;
...
import seedu.address.logic.parser.meetingentry.EditMeetingCommandParser;
...
public class EditMeetingCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        final Index targetIndex = INDEX_SECOND_MEETING_ENTRY;
    ...
    public void parse_someFieldsSpecified_success() {
        final Index targetIndex = INDEX_FIRST_MEETING_ENTRY;
    ...
    public void parse_oneFieldSpecified_success() {
        // name
        final Index targetIndex = INDEX_THIRD_MEETING_ENTRY;
