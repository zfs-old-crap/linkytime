...
public class LinkyTimeParserTest {
    ...
    public void parseCommand_add() throws Exception {
        MeetingEntry meetingEntry = new MeetingEntryBuilder().build();
        AddCommand command = (AddCommand) parser.parseCommand(MeetingUtil.getAddCommand(meetingEntry));
        assertEquals(new AddCommand(meetingEntry), command);
    }
