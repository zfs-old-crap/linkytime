...
| Error                                                                                          | What it means                                                                                                                                                                                                                 |
|------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Unknown Command**                                                                            | An unrecognised command word was supplied. <br/> E.g., The command word was given in upper case.                                                                                                                              |
| **Invalid Command**                                                                            | You are not following the exact command format of the command word that was entered. E.g., missing some compulsory parameters. <br> The correct format would be listed after this error message for convenience.              |
...
| **Names should only contain alphanumeric characters and spaces, and it should not be blank**   | Self explanatory.                                                                                                                                                                                                             |
| **URLs should be a valid link, and it should not be blank**                                    | The URL provided should be in one of the following formats (either `https` or `http` is fine): <ul> <li>`https://www.example.com`</li> <li>`https://example.com`</li> <li>`www.example.com`</li> <li>`example.com`</li> </ul> |
| **DateTime should be formatted as dd-MM-yyyy HHmm; e.g. 30-04-2022 1400**                      | The dateTime given is invalid. E.g., <br/> <ul> <li>Giving dates that do not exist 29th of February</li> <li>Giving time that does not exist like 2500 hours</li></ul>                                                        |
| **Meeting recurrence status can only be a single letter `Y` or `N`**                           | Self explanatory.                                                                                                                                                                                                             |
| **Tags names should be alphanumeric**                                                          | The tags given were not alphanumeric, spaces are not allowed.                                                                                                                                                                 |
| **At least one field to edit must be provided.**                                               | No fields to edit were supplied together with the edit command. As for `medit`, since there is currently only 1 field, it is compulsory as stated in the features section in this User Guide.                                 |
| **Unable to delete Module: `[MODULE_NAME]` <br/> There are meetings assigned to this module.** | The module is unable to be delete as there are still meetings that exist in LinkyTime that are of this module. Please refer to the features section in this User Guide on how to force delete a module.                       |
| **This module already exists in LinkyTime.**                                                   | You have tried to either add another of the same meeting, or editing a meeting such that the edited meeting will now have all the same fields as another meeting.                                                             |
