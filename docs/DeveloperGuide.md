...
* **Adding meeting and module models**
  ...
  * We also had to create UniqueList to ensure that there are no duplicates for both Meeting and Module.
  * Finally, due to using Meetings and Module, we had to refactor the majority of the code base in order to accommodate these changes.
